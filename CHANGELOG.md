...
- **fix**: 初始化密码环境变量名统一为 `InitAdmin__Password`
...
- 详细变更见 [Auth/CHANGELOG.md](./Auth/CHANGELOG.md#v050-2026-06-02)

## v1.4.0 (2026-06-01)

- **feat**: 集成 Auth v0.3.0 — 登录页全面重做 + RSA-OAEP 前端加密 + 安全响应头 + 审计日志
- 详细变更见 [Auth/CHANGELOG.md](./Auth/CHANGELOG.md#v030-2026-06-01)

## v1.3.2 (2026-06-01)

- **docs**：RELEASE.md 新增步骤⑧ — 主发布后自动同步子项目分支（`--ff-only`）
- **docs**：CLAUDE.md 关键决策记录追加同步规则
